...
tdOff.Actions.Add(new ExecAction(@"C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe",arguments:string.Format("pnputil /disable-device \"{0}\"", "PCI\\VEN_1002'&'DEV_73EF'&'SUBSYS_1DCC1043'&'REV_C0\\6'&'E1D2937'&'0'&'00000009")));
...
tdOn.Actions.Add(new ExecAction(@"C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe",arguments:string.Format("pnputil /enable-device \"{0}\"", "PCI\\VEN_1002'&'DEV_73EF'&'SUBSYS_1DCC1043'&'REV_C0\\6'&'E1D2937'&'0'&'00000009")));
